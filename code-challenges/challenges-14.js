...
const LastWord = (str) => {
  ...
  const lastSpaceIndex = str.lastIndexOf(' '); // will count the index of last space (8)
  if (lastSpaceIndex === -1) {
    return str;
  } else {
    return str.slice(lastSpaceIndex + 1); // return 8+1 = 9 which will go to index 9 and delete all the previous words. 
  }
};
// -------------------------------------------------------------------------------------------------------
...
const LastWord_2 = (str) => {
  ...
  // write your code here
  let words = str.split(' '); // here means split whenever you found a space (' ')
...
const replaceWords = (str) => {
  // write your code here
  let words = str.split(' '); // here means split whenever you find a space (' ') , returns an array 

  for (let i = 0; i < words.length; i++) {
    if (words[i] === 'I') {
      words.splice(i, 1, 'We'); // arguments of splice(start,NO. ofe deleting elements,'word' to be added)
    } else if (words[i] === 'am') {
