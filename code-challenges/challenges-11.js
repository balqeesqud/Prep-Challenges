...
function square(arr) {
  ...
  let squaredArr = arr.map(function (number) {
...
function fullName(arr) {
  // write your code here
  let fullNameArr = arr.map(function (student) {
...
function gradesAvg(arr) {
  // write your code here
  var Students = arr.map(function (student) {
    var sum = 0;
    student.gradsList.forEach(function (grade) {
      sum += grade;
    });
    var avg = sum / student.gradsList.length;
