...
const cvsFiltration = (arr) => {
    // write your code here
    let candidatesFiltered = arr.filter(candidate => {
        return candidate.yearsOfExperience > 4 && candidate.tech === "JS";
      });
    
      return candidatesFiltered.map(candidate => ({
        fullName: candidate.firstName + (candidate.LastName ? " " + candidate.LastName : ""),
        tech: candidate.tech
      }));
}
// -------------------------------------------------------------------------------------------------------
...
const vowelsFiltration = (arr) => {
    // write your code here
    let vowelsFiltered = arr.filter(word => {
        return !/[aeiou]/i.test(word);
      });
    
      return vowelsFiltered;
