...
const isPalindrome = (str) => {
  // write your code here
    const stringCleared = str.toLowerCase().replace(/[^a-z0-9]/g, "");
    const stringReversed = stringCleared.split("").reverse().join("");
  
    return stringCleared === stringReversed;
  };
